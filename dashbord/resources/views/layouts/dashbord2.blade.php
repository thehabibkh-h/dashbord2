...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="../../dist/img/contact.png" class="img-circle elevation-2" alt="User Image">
        </div>
  ...
  <footer class="main-footer" >
    <div class="float-right d-none d-sm-block">
      <b>© Société Générale • {{date("Y")}}</b>

    </div>
    <div class='image' style="position: relative;bottom: 20px;">
      <img src="../../dist/img/sg-logo.png" width="200" height="80"  alt="User Image">
    </div>
  </footer>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-table/1.16.0/extensions/toolbar/bootstrap-table-toolbar.min.js" ></script>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-table/1.16.0/extensions/print/bootstrap-table-print.min.js" ></script>
